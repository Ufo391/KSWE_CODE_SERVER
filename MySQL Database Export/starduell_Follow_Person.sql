...
DROP TABLE IF EXISTS `Follow_Person`;
...
CREATE TABLE `Follow_Person` (
  ...
  CONSTRAINT `follow_Person_follower` FOREIGN KEY (`follower_username`) REFERENCES `Person` (`username`) ON DELETE CASCADE ON UPDATE CASCADE
...
LOCK TABLES `Follow_Person` WRITE;
/*!40000 ALTER TABLE `Follow_Person` DISABLE KEYS */;
/*!40000 ALTER TABLE `Follow_Person` ENABLE KEYS */;
UNLOCK TABLES;
